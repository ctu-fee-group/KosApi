...
{
    /// <summary>
    /// Represents mapping to kos parameters api.
    /// </summary>
    public interface IKosParametersApi
    {
        /// <summary>
        /// Gets paged parameters filtered using RSQL query.
        /// </summary>
        ...
        /// <summary>
        /// Gets Parameter by its key.
        /// </summary>
        /// <param name="key">The key of the parameter.</param>
        /// <param name="lang">The request language. Supports cs or en.</param>
        /// <param name="token">The cancellation token for the operation.</param>
        /// <returns>The loaded parameter.</returns>
        public Task<Parameter?> GetParameter
        (
            string key,
            string? lang = null,
            CancellationToken token = default
